...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-[#030303] overflow-hidden px-4 pt-16">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[280px] md:w-[480px] h-[280px] md:h-[480px] pointer-events-none" aria-hidden>
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <img src="/hero-sphere.png" alt="NovaDeck Hero" className="w-48 h-48 md:w-80 md:h-80 object-contain animate-[bounce_8s_ease-in-out_infinite]" />
        </div>
      </div>
